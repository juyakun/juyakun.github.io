...
**Dynamic Mutual Learning for Object Detection in Aerial Imagery**  
  C. Zhang, C. Yang, **Y. Ju**, J. Xiao, M. Jian, K.-M. Lam, Q. Wang.  
...
**DA-GAN: Dual-Attention GAN for Underwater Image Enhancement With Contrast and Color Correction**  
  X. Liu, H. Xu, **Y. Ju**, S. Wang, C. Liu, L. Chen.  
  *IEEE Transactions on Geoscience and Remote Sensing*, 2026. 
<br>
<br>
**DCD-UIE: Decoupled Chromatic Diffusion Model for Underwater Image Enhancement**  
  G. Fan, Y. Zhou, J. Zhou, **Y. Ju**, G.-Y. Chen, J. Li, A. C. Kot.  
...
**SHARE-U: Semantic-aware Human Avatar Reconstruction with Efficient Gaussians via Uncertainty-weighted Contrastive Learning**  
  Z. Han, S. Wu, J. Qiu, **Y. Ju**, L. Liu, P. Feng, H. Zhou, Z. Jiang.  
  *IEEE Transactions on Multimedia*, 2026. 
<br>
<br>
**SGDFuse: SAM-Guided Diffusion Model for High-Fidelity Infrared and Visible Image Fusion**  
  X. Zhang, J. Li, G. Fan, **Y. Ju**, L. Fan, J. Liu, A. C. Kot.  
  *Information Fusion*, 2026. 
<br>
<br>
**Perception-Inspired Network for Stereo Image Quality Assessment**  
  Y. Chang, G. Yue, B. Zhao, L. Yu, **Y. Ju**, H. Amirpour, M. Gabbouj, W. Zhou.  
  *IEEE Transactions on Image Processing*, 2026. 
<br>
<br>
**Polarisation-DCP Fusion Imaging and Rolling Ball 3D Reconstruction Method for Quantitative Analysis of Underwater Structural Defects**  
  J. Gan, X. Lin, Y. Ye, L. Liu, S. Zhang, **Y. Ju**, Z. Xu.  
  *Measurement*, 2026. 
<br>
<br>
...
**A Novel Stereo Matching Network for Underwater Scenes**  
  L. Zhu, **Y. Ju**, Y. Gao.  
  *Proceedings of the IEEE International Symposium on Circuits and Systems (ISCAS)*, 2025. 
<br>
<br>
**HRHuman: Tuning-free Higher-resolution Human Image Generation via Template Knowledge**  
  L. Li, L. Guo, S. Yang, Q. Zheng, **Y. Ju**, W. Lin, A. C. Kot.  
  *Proceedings of the IEEE International Symposium on Circuits and Systems (ISCAS)*, 2025. 
<br>
...
**Towards Progressive Multi-frequency Representation for Image Warping**  
  J. Xiao, Z. Lyu, C. Zhang, **Y. Ju**, C. Shui, K.-M. Lam.  
  *Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR)*, 2024. 
<br>
<br>
**Frequency-aware Guidance for Blind Image Restoration via Diffusion Models**  
  J. Xiao, Z. Lyu, H. Xie, C. Zhang, **Y. Ju**, C. Shui, K.-M. Lam.  
  *Proceedings of the European Conference on Computer Vision Workshops (ECCV Workshops)*, 2024. 
<br>
<br>
**Image Gradient-aided Photometric Stereo Network**  
  K. Wang, L. Qi, S. Qin, K. Luo, **Y. Ju**, X. Li, J. Dong.  
  *Proceedings of the Pacific Rim International Conference on Artificial Intelligence (PRICAI)*, 2024. 
<br>
<br>
**Aligning Localization and Classification for Anchor-free Object Detection in Aerial Imagery**  
  C. Zhang, **Y. Ju**, J. Xiao, Y. Yang, K.-M. Lam.  
  *Proceedings of the International Workshop on Advanced Imaging Technology (IWAIT)*, 2024. 
<br>
<br>
**Dynamic Spatial Aggregation Network for Joint Denoising and HDR Imaging**  
  J. Xiao, C. Yang, C. Zhang, **Y. Ju**, K.-M. Lam.  
  *Proceedings of the International Workshop on Advanced Imaging Technology (IWAIT)*, 2024. 
<br>
...
**Learning Deep Photometric Stereo Network with Reflectance Priors**  
  **Y. Ju**, C. Zhang, S. Huang, Y. Rao, K.-M. Lam.  
  *Proceedings of the IEEE International Conference on Multimedia and Expo (ICME)*, 2023. 
<br>
<br>
**Deep Discrete Wavelet Transform Network for Photometric Stereo**  
  **Y. Ju**, M. Jian, C. Zhang, Y. Hu, K.-M. Lam.  
  *Proceedings of the International Conference on Digital Signal Processing (DSP)*, 2023. 
<br>
<br>
**A Structure-affinity Dual Attention-based Network to Segment Spine for Scoliosis Assessment**  
  H. Xie, Z. Huang, F. H. F. Leung, **Y. Ju✉**, Y.-P. Zheng, S.-H. Ling.  
  *Proceedings of the IEEE International Conference on Bioinformatics and Biomedicine (BIBM)*, 2023. 
<br>
<br>
**PMBQA: Projection-based Blind Point Cloud Quality Assessment via Multimodal Learning**  
  W. Xie, K. Wang, **Y. Ju**, M. Wang.  
...
**Learning Photometric Stereo via Manifold-based Mapping**  
  **Y. Ju**, M. Jian, J. Dong, K.-M. Lam.  
  *Proceedings of the IEEE International Conference on Visual Communications and Image Processing (VCIP)*, 2020. 
<br>
<br>
**Self-supervised Depth Completion with Attention-based Loss**  
  Y. Wang, **Y. Ju**, M. Jian, K.-M. Lam, L. Qia, J. Dong.  
  *Proceedings of the International Workshop on Advanced Imaging Technology (IWAIT)*, 2020. 
<br>
<br>
**Photometric Stereo via Random Sampling and Tensor Robust Principal Component Analysis**  
  **Y. Ju**, L. Qi, H. Fan, L. Lu, J. Dong.  
  *Proceedings of the International Conference on Graphic and Image Processing (ICGIP)*, 2018. 
<br>
